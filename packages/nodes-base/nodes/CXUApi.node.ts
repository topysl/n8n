...
export class CXUApi implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'CXU Rule',
		name: 'CXU Api',
		icon: 'fa:at',
		group: ['input'],
		version: 1,
		subtitle: '={{$parameter["requestMethod"] + ": " + $parameter["url"]}}',
		description: 'Makes a call request and returns the result',
		defaults: {
			name: 'High Spender Persona',
			color: '#007f7f',
		},
		inputs: ['main'],
		outputs: ['main'],
		...
		properties: [
			...
			},
			{
				...
				name: 'url',
				type: 'string',
				default: 'http://localhost:9093/rules/cxu/',
