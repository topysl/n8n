...
export class MachineLearningApi implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'MachineLearning Rules',
		...
		properties: [
			...
			},
			{
				...
				name: 'url',
				type: 'string',
				default: 'http://localhost:9093/rules/machine_learning/',
