...
export class McpsJobAdminApi implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'McpsJob Admin',
		name: 'Mcps Job Admin Api',
		icon: 'fa:at',
		group: ['input'],
		version: 1,
		...
		properties: [
			...
			},
			{
				...
				name: 'url',
				type: 'string',
				default: "=http://dev-mcps.cxunity.ocs.oc-test.com/api-admin/v1/04fe3a01f14345b1b09b4b54d466da30/admin/job/INGEST/{{$node[\"Possible Buys\"].json[\"jobId\"]}}/start",
					...
					"parameter": [
						{
							...
							value: "82ad965f10014055ad664672eed6ff47"
						},
						{
							name: "idcs_user_id",
							value: "cba7fadb39a54df6ad7d333352934d6f"
						},
						{
							name: "Content-Type",
